...
CH_RiboTag_salmon_directory=file.path("~/ruthasinger_github/OptoCLIP/RDS_files/Data_CHale_et_al_2021_RiboTag_salmon")
...
saveRDS(CH_RT_resdata, file=file.path("~/ruthasinger_github/OptoCLIP/RDS_files","CH_RT_resdata.rds"))
