...
mm10_gtf_directory=file.path("~/ruthasinger_github/OptoCLIP/RDS_files/Data_mm10gtf")
...
##############################################################################################################
#save RDS files
saveRDS(mm10_Tx_final, file=file.path("~/ruthasinger_github/OptoCLIP/RDS_files","mm10_Tx_final.rds"))
saveRDS(mm10_txdb_lengths, file=file.path("~/ruthasinger_github/OptoCLIP/RDS_files","mm10_txdb_lengths.rds"))
