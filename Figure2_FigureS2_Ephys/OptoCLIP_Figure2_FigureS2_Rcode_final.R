...
Base_directory=file.path("~/ruthasinger_github/OptoCLIP/Figure2_FigureS2_Ephys")
...
Rheostat_mean_plot
ggsave(file.path(Outdirectory, "Supplementary_Fig_2c.pdf"), Rheostat_mean_plot, device = "pdf", width = 3, height = 2, units = "in")
...
plot_Vm_one_cell <- function(abf_path, sweep_pA_map,
  ...
  print(Vm_plot)
  ggsave(
    filename = file.path(Outdirectory, "Supplementary_Fig_2a_scale_100ms_10mV.pdf"),
...
plot_pA_one_cell <- function(abf_path,
  ...
  print(pA_plot)
  ggsave(
    filename = file.path(Outdirectory, "Supplementary_Fig_2b_scale_100ms_25pA.pdf"),
...
OneHz_plot
ggsave(filename = file.path(Outdirectory,"Figure_2c_scale_1s_10mV.pdf"), plot= OneHz_plot, device='pdf', width=1.7,height=2.25,unit="in")
...
OneHz_plot_zoom=ggplot() +
  ...
  theme(legend.position="none")
OneHz_plot_zoom
ggsave(filename = file.path(Outdirectory,"Figure_2c'_scale_100ms_10mV_zoom_4to6.pdf"), plot= OneHz_plot_zoom, device='pdf', width=1.7,height=2.25,unit="in")
...
FiveHz_plot=ggplot() +
  ...
  theme(legend.position="none")
FiveHz_plot
ggsave(filename = file.path(Outdirectory,"Figure_2d_scale_1s_10mV.pdf"), plot= FiveHz_plot, device='pdf',width=1.7,height=2.25,unit="in")
...
FiveHz_plot_zoom=ggplot() +
  ...
  theme(legend.position="none")
FiveHz_plot_zoom
ggsave(filename = file.path(Outdirectory,"Figure_2d'_scale_100ms_10mV_zoom_4to6.pdf"), plot= FiveHz_plot_zoom, device='pdf',width=1.7,height=2.25,unit="in")
...
TenHz_plot=ggplot() +
  ...
  theme(legend.position="none")
TenHz_plot
ggsave(filename = file.path(Outdirectory,"Figure_2e_scale_1s_10mV.pdf"), plot= TenHz_plot, device='pdf', width=1.7,height=2.25,unit="in")
...
TenHz_plot_zoom=ggplot() +
  ...
  theme(legend.position="none")
TenHz_plot_zoom
ggsave(filename = file.path(Outdirectory,"Figure_2e'_scale_100ms_10mV_zoom_4to6.pdf"), plot= TenHz_plot_zoom, device='pdf', width=1.7,height=2.25,unit="in")
...
p_side_by_side_bar
ggsave(filename = file.path(Outdirectory,"Figure_2g.pdf"), plot= p_side_by_side_bar, device='pdf', width=5, height=7)
